...
BEGIN_MESSAGE_MAP(CThreadDemoDlg, CDialog)
	...
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BUTTON1, &CThreadDemoDlg::OnBnClickedButton1)
	ON_WM_DESTROY()
	ON_BN_CLICKED(IDC_BUTTON2, &CThreadDemoDlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
void CThreadDemoDlg::OnBnClickedButton1()
{
	// TODO: Add your control notification handler code here
	frontend_->DoRequest1();
}

void CThreadDemoDlg::OnDestroy()
{
	CDialog::OnDestroy();
...
void CThreadDemoDlg::OnBnClickedButton2()
{
	// TODO: Add your control notification handler code here
	frontend_->thread_->message_loop()->PostDelayedTask
		( FROM_HERE
		, base::Bind
			( &CFrontend::DoRequest2
			, base::Unretained(frontend_.get())
			)
		, 0
		);
}
